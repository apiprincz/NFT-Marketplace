            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Originality</h4>
                  <p className="m-0 text-sm">
                    KuNFT's are purpose built to tell a story. We believe the
                    beauty of an art lies in the story behind it.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    All KuNFT's will be hosted on the Kucoin chain at first.
                    Before being integrated into other secure decentralised
                    options.
                  </p>
                </div>
              </div>
